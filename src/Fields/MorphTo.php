...
class MorphTo extends Field implements FilterableField, RelatableField
{
     ...
     *
     * @var class-string<\Jegex\Koboi\Resource>|null
     */
     ...
     *
     * @var callable|array<class-string<\Jegex\Koboi\Resource>, callable>|string
     */
    public $display;
     ...
     *
     * @param  array<int, class-string<\Jegex\Koboi\Resource>>|array<class-string<\Jegex\Koboi\Resource>, string>  $types
     * @return $this
     */
     ...
     *
     * @param  callable|array<class-string<\Jegex\Koboi\Resource>, callable>|string  $display
     * @return $this
     */
