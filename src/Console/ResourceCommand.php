...
class ResourceCommand extends GeneratorCommand implements PromptsForMissingInput
{
    ...
    protected function buildClass($name)
    {
        ...
        if (! class_exists($baseResourceClass)) {
            $baseResourceClass = 'Jegex\Koboi\Resource';
        ...
        return str_replace(
            'use Jegex\Koboi\Http\Requests\NovaRequest;'.$eol,
            'use Jegex\Koboi\Http\Requests\NovaRequest;'.$eol."use {$baseResourceClass};".$eol,
            $result
        );
    }
