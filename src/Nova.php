...
use Jegex\Koboi\Exceptions\ResourceMissingException;
use Jegex\Koboi\Http\Requests\NovaRequest;
use Jegex\Koboi\Menu\Menu;
use Jegex\Koboi\Support\PendingTranslation;
...
class Nova
{
     ...
     *
     * @var array<int, class-string<\Jegex\Koboi\Resource>>
     */
     ...
     *
     * @var (callable(class-string<\Jegex\Koboi\Resource>):(mixed))|null
     */
     ...
     *
     * @return callable(class-string<\Jegex\Koboi\Resource>):mixed
     */
    ...
    public static function groups(Request $request): Collection
    {
        return collect(static::availableResources($request))
            ->map(static function ($resourceClass) {
                /** @var class-string<\Jegex\Koboi\Resource> $resourceClass */
     ...
     * Get the resources available for the given request.
     *
     * @return array<int, class-string<\Jegex\Koboi\Resource>>
     */
    ...
    public static function resourcesIn(string $directory): void
    {
        ...
        /** @var array<int, class-string<\Jegex\Koboi\Resource>> $resources */
        $resources = [];
     ...
     *
     * @param  callable(class-string<\Jegex\Koboi\Resource>):mixed  $callback
     */
